import 'package:billing_app/components/edit_utility.dart';
import 'package:billing_app/state_data.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
class PendingCard extends StatelessWidget with EditUtility {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onLongPress: () => showEditDialog(context,item),
      child: Card(
        color: Colors.black,
